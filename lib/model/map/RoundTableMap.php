...
class RoundTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'lib.model.map.RoundTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addColumn('FROM', 'From', 'TIMESTAMP', false, null, null);
        $this->addColumn('TO', 'To', 'TIMESTAMP', false, null, null);
        $this->addColumn('SHOW_RESULTS', 'ShowResults', 'BOOLEAN', false, 1, false);
    ...
    {
        $this->addRelation('Answer', 'Answer', RelationMap::ONE_TO_MANY, array('id' => 'round_id', ), null, null, 'Answers');
    } // buildRelations()
