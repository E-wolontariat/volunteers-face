 ...
 */
abstract class BaseAnswer extends BaseObject 
{
    ...
    public function setRoundId($v)
    {
        ...
        if ($this->round_id !== $v) {
            $this->round_id = $v;
            $this->modifiedColumns[] = AnswerPeer::ROUND_ID;
        }
    ...
    public function setContent($v)
    {
        ...
        if ($this->content !== $v) {
            $this->content = $v;
            $this->modifiedColumns[] = AnswerPeer::CONTENT;
        }
    ...
    public function setIsWinner($v)
    {
        ...
        if ($this->is_winner !== $v) {
            $this->is_winner = $v;
            $this->modifiedColumns[] = AnswerPeer::IS_WINNER;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->round_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->content = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->is_winner = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
            ...
            return $startcol + 7; // 7 = AnswerPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AnswerPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`USER_ID`';
        }
        if ($this->isColumnModified(AnswerPeer::ROUND_ID)) {
            $modifiedColumns[':p' . $index++]  = '`ROUND_ID`';
        }
        if ($this->isColumnModified(AnswerPeer::CONTENT)) {
            $modifiedColumns[':p' . $index++]  = '`CONTENT`';
        }
        if ($this->isColumnModified(AnswerPeer::IS_WINNER)) {
            $modifiedColumns[':p' . $index++]  = '`IS_WINNER`';
        }
        if ($this->isColumnModified(AnswerPeer::UPDATED_AT)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`CONTENT`':
                        ...
                        break;
                    case '`IS_WINNER`':
						$stmt->bindValue($identifier, (int) $this->is_winner, PDO::PARAM_INT);
                        break;
                    case '`UPDATED_AT`':
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aRound) {
                $result['Round'] = $this->aRound->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setIsWinner($arr[$keys[4]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AnswerPeer::ROUND_ID)) $criteria->add(AnswerPeer::ROUND_ID, $this->round_id);
        if ($this->isColumnModified(AnswerPeer::CONTENT)) $criteria->add(AnswerPeer::CONTENT, $this->content);
        if ($this->isColumnModified(AnswerPeer::IS_WINNER)) $criteria->add(AnswerPeer::IS_WINNER, $this->is_winner);
    ...
    /**
     * Declares an association between this object and a Round object.
     *
     * @param                  Round $v
     * @return                 Answer The current object (for fluent API support)
     * @throws PropelException
     */
    public function setRound(Round $v = null)
    {
        if ($v === null) {
        ...
        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the Round object, it will not be re-added.
        if ($v !== null) {
            $v->addAnswer($this);
        }
    ...
    /**
     * Get the associated Round object
     *
     * @param      PropelPDO $con Optional Connection object.
     * @return                 Round The associated Round object.
     * @throws PropelException
     */
    public function getRound(PropelPDO $con = null)
    {
        if ($this->aRound === null && ($this->round_id !== null)) {
            $this->aRound = RoundQuery::create()->findPk($this->round_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aRound->addAnswers($this);
             */
        }
    ...
    public function __call($name, $params)
    {
		...
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseAnswer:' . $name))
		{
