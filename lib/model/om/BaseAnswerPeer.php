...
abstract class BaseAnswerPeer {
    ...
    const ROUND_ID = 'answer.ROUND_ID';

    /** the column name for the CONTENT field */
    const CONTENT = 'answer.CONTENT';

    /** the column name for the IS_WINNER field */
    const IS_WINNER = 'answer.IS_WINNER';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'RoundId', 'Content', 'IsWinner', 'UpdatedAt', 'CreatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'roundId', 'content', 'isWinner', 'updatedAt', 'createdAt', ),
        BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::ROUND_ID, self::CONTENT, self::IS_WINNER, self::UPDATED_AT, self::CREATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USER_ID', 'ROUND_ID', 'CONTENT', 'IS_WINNER', 'UPDATED_AT', 'CREATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'round_id', 'content', 'is_winner', 'updated_at', 'created_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'RoundId' => 2, 'Content' => 3, 'IsWinner' => 4, 'UpdatedAt' => 5, 'CreatedAt' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'roundId' => 2, 'content' => 3, 'isWinner' => 4, 'updatedAt' => 5, 'createdAt' => 6, ),
        BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::ROUND_ID => 2, self::CONTENT => 3, self::IS_WINNER => 4, self::UPDATED_AT => 5, self::CREATED_AT => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USER_ID' => 1, 'ROUND_ID' => 2, 'CONTENT' => 3, 'IS_WINNER' => 4, 'UPDATED_AT' => 5, 'CREATED_AT' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'round_id' => 2, 'content' => 3, 'is_winner' => 4, 'updated_at' => 5, 'created_at' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AnswerPeer::ROUND_ID);
            $criteria->addSelectColumn(AnswerPeer::CONTENT);
            $criteria->addSelectColumn(AnswerPeer::IS_WINNER);
    ...
    /**
     * Method to invalidate the instance pool of all tables related to answer
    ...
    public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(AnswerPeer::USER_ID, UserPeer::ID, $join_behavior);
    ...
    /**
     * Returns the number of rows matching criteria, joining the related Round table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinRound(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
        ...
        $criteria->addJoin(AnswerPeer::ROUND_ID, RoundPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Answer objects pre-filled with their Round objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Answer objects.
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinRound(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $key2 = RoundPeer::getPrimaryKeyHashFromRow($row, $startcol);
            if ($key2 !== null) {
                $obj2 = RoundPeer::getInstanceFromPool($key2);
                if (!$obj2) {

                    $cls = RoundPeer::getOMClass();

                    $obj2 = new $cls();
                    $obj2->hydrate($row, $startcol);
                    RoundPeer::addInstanceToPool($obj2, $key2);
                } // if obj2 already loaded

                // Add the $obj1 (Answer) to $obj2 (Round)
                $obj2->addAnswer($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        RoundPeer::addSelectColumns($criteria);
        $startcol4 = $startcol3 + RoundPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            // Add objects for joined Round rows

            $key3 = RoundPeer::getPrimaryKeyHashFromRow($row, $startcol3);
            if ($key3 !== null) {
                $obj3 = RoundPeer::getInstanceFromPool($key3);
                if (!$obj3) {
                    ...
                    RoundPeer::addInstanceToPool($obj3, $key3);
                } // if obj3 loaded

                // Add the $obj1 (Answer) to the collection in $obj3 (Round)
                $obj3->addAnswer($obj1);
            } // if joined row not null
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinAllExceptRound(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
    ...
    public static function doSelectJoinAllExceptUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        RoundPeer::addSelectColumns($criteria);
        $startcol3 = $startcol2 + RoundPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = AnswerPeer::getInstanceFromPool($key1))) {
                ...
                $key2 = RoundPeer::getPrimaryKeyHashFromRow($row, $startcol2);
                if ($key2 !== null) {
                    $obj2 = RoundPeer::getInstanceFromPool($key2);
                    if (!$obj2) {
                ...
                // Add the $obj1 (Answer) to the collection in $obj2 (Round)
                $obj2->addAnswer($obj1);
    ...
    /**
     * Selects a collection of Answer objects pre-filled with all related objects except Round.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinAllExceptRound(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
