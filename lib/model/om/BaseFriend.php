...
abstract class BaseFriend extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the facebook_friend_id field.
     * @var        string
     */
    protected $facebook_friend_id;
    ...
    /**
     * Get the [facebook_friend_id] column value.
     *
     * @return string
     */
    public function getFacebookFriendId()
    {
        return $this->facebook_friend_id;
    }
    ...
    public function setFriendId($v)
    {
        ...
        if ($this->friend_id !== $v) {
            $this->friend_id = $v;
            $this->modifiedColumns[] = FriendPeer::FRIEND_ID;
        }

        if ($this->aUserRelatedByFriendId !== null && $this->aUserRelatedByFriendId->getId() !== $v) {
    ...
    /**
     * Set the value of [facebook_friend_id] column.
     *
     * @param string $v new value
     * @return Friend The current object (for fluent API support)
     */
    public function setFacebookFriendId($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->facebook_friend_id !== $v) {
            $this->facebook_friend_id = $v;
            $this->modifiedColumns[] = FriendPeer::FACEBOOK_FRIEND_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->facebook_friend_id = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            ...
            return $startcol + 4; // 4 = FriendPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aUserRelatedByFriendId !== null && $this->friend_id !== $this->aUserRelatedByFriendId->getId()) {
            $this->aUserRelatedByFriendId = null;
        }
    } // ensureConsistency
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(FriendPeer::FRIEND_ID)) {
            $modifiedColumns[':p' . $index++]  = '`FRIEND_ID`';
        }
        if ($this->isColumnModified(FriendPeer::FACEBOOK_FRIEND_ID)) {
            $modifiedColumns[':p' . $index++]  = '`FACEBOOK_FRIEND_ID`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`FRIEND_ID`':
                        ...
                        break;
                    case '`FACEBOOK_FRIEND_ID`':
                        $stmt->bindValue($identifier, $this->facebook_friend_id, PDO::PARAM_INT);
                        break;
                    case '`ID`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aUserRelatedByFriendId !== null) {
                if (!$this->aUserRelatedByFriendId->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aUserRelatedByFriendId->getValidationFailures());
                }
            }
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                return $this->getFacebookFriendId();
                break;
            case 3:
                return $this->getId();
                break;
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getFacebookFriendId(),
            $keys[3] => $this->getId(),
        );
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aUserRelatedByFriendId) {
                $result['UserRelatedByFriendId'] = $this->aUserRelatedByFriendId->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setFacebookFriendId($value);
                break;
            case 3:
                $this->setId($value);
                break;
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setFacebookFriendId($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FriendPeer::FRIEND_ID)) $criteria->add(FriendPeer::FRIEND_ID, $this->friend_id);
        if ($this->isColumnModified(FriendPeer::FACEBOOK_FRIEND_ID)) $criteria->add(FriendPeer::FACEBOOK_FRIEND_ID, $this->facebook_friend_id);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setFacebookFriendId($this->getFacebookFriendId());
     ...
     * @throws PropelException
     */
    public function setUserRelatedByFriendId(User $v = null)
    {
        if ($v === null) {
     ...
     * @throws PropelException
     */
    public function getUserRelatedByFriendId(PropelPDO $con = null)
    {
        if ($this->aUserRelatedByFriendId === null && ($this->friend_id !== null)) {
            $this->aUserRelatedByFriendId = UserQuery::create()->findPk($this->friend_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
