...
abstract class BasePage extends BaseObject implements Persistent
{
    ...
    public function setFoundationId($v)
    {
        ...
        if ($this->foundation_id !== $v) {
            ...
            $this->modifiedColumns[] = PagePeer::FOUNDATION_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->foundation_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PagePeer::FOUNDATION_ID)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setFoundationId($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PagePeer::FOUNDATION_ID)) $criteria->add(PagePeer::FOUNDATION_ID, $this->foundation_id);
    ...
    public function getFoundation(PropelPDO $con = null)
    {
        if ($this->aFoundation === null && ($this->foundation_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aFoundation->addPages($this);
             */
        }
