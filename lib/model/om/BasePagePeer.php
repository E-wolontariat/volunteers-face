...
abstract class BasePagePeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'FacebookId', 'UserId', 'AccessToken', 'LastSync', 'UpdatedAt', 'CreatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'facebookId', 'userId', 'accessToken', 'lastSync', 'updatedAt', 'createdAt', ),
        BasePeer::TYPE_COLNAME => array (PagePeer::ID, PagePeer::FACEBOOK_ID, PagePeer::USER_ID, PagePeer::ACCESS_TOKEN, PagePeer::LAST_SYNC, PagePeer::UPDATED_AT, PagePeer::CREATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'FACEBOOK_ID', 'USER_ID', 'ACCESS_TOKEN', 'LAST_SYNC', 'UPDATED_AT', 'CREATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'facebook_id', 'user_id', 'access_token', 'last_sync', 'updated_at', 'created_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'FacebookId' => 1, 'UserId' => 2, 'AccessToken' => 3, 'LastSync' => 4, 'UpdatedAt' => 5, 'CreatedAt' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'facebookId' => 1, 'userId' => 2, 'accessToken' => 3, 'lastSync' => 4, 'updatedAt' => 5, 'createdAt' => 6, ),
        BasePeer::TYPE_COLNAME => array (PagePeer::ID => 0, PagePeer::FACEBOOK_ID => 1, PagePeer::USER_ID => 2, PagePeer::ACCESS_TOKEN => 3, PagePeer::LAST_SYNC => 4, PagePeer::UPDATED_AT => 5, PagePeer::CREATED_AT => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'FACEBOOK_ID' => 1, 'USER_ID' => 2, 'ACCESS_TOKEN' => 3, 'LAST_SYNC' => 4, 'UPDATED_AT' => 5, 'CREATED_AT' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'facebook_id' => 1, 'user_id' => 2, 'access_token' => 3, 'last_sync' => 4, 'updated_at' => 5, 'created_at' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
