...
abstract class BasePagePeer
{
    ...
    const FACEBOOK_ID = 'page.FACEBOOK_ID';

    /** the column name for the FOUNDATION_ID field */
    const FOUNDATION_ID = 'page.FOUNDATION_ID';
    ...
    const LAST_SYNC = 'page.LAST_SYNC';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'FacebookId', 'FoundationId', 'UserId', 'AccessToken', 'LastSync', 'UpdatedAt', 'CreatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'facebookId', 'foundationId', 'userId', 'accessToken', 'lastSync', 'updatedAt', 'createdAt', ),
        BasePeer::TYPE_COLNAME => array (PagePeer::ID, PagePeer::FACEBOOK_ID, PagePeer::FOUNDATION_ID, PagePeer::USER_ID, PagePeer::ACCESS_TOKEN, PagePeer::LAST_SYNC, PagePeer::UPDATED_AT, PagePeer::CREATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'FACEBOOK_ID', 'FOUNDATION_ID', 'USER_ID', 'ACCESS_TOKEN', 'LAST_SYNC', 'UPDATED_AT', 'CREATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'facebook_id', 'foundation_id', 'user_id', 'access_token', 'last_sync', 'updated_at', 'created_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'FacebookId' => 1, 'FoundationId' => 2, 'UserId' => 3, 'AccessToken' => 4, 'LastSync' => 5, 'UpdatedAt' => 6, 'CreatedAt' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'facebookId' => 1, 'foundationId' => 2, 'userId' => 3, 'accessToken' => 4, 'lastSync' => 5, 'updatedAt' => 6, 'createdAt' => 7, ),
        BasePeer::TYPE_COLNAME => array (PagePeer::ID => 0, PagePeer::FACEBOOK_ID => 1, PagePeer::FOUNDATION_ID => 2, PagePeer::USER_ID => 3, PagePeer::ACCESS_TOKEN => 4, PagePeer::LAST_SYNC => 5, PagePeer::UPDATED_AT => 6, PagePeer::CREATED_AT => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'FACEBOOK_ID' => 1, 'FOUNDATION_ID' => 2, 'USER_ID' => 3, 'ACCESS_TOKEN' => 4, 'LAST_SYNC' => 5, 'UPDATED_AT' => 6, 'CREATED_AT' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'facebook_id' => 1, 'foundation_id' => 2, 'user_id' => 3, 'access_token' => 4, 'last_sync' => 5, 'updated_at' => 6, 'created_at' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PagePeer::FACEBOOK_ID);
            $criteria->addSelectColumn(PagePeer::FOUNDATION_ID);
            $criteria->addSelectColumn(PagePeer::USER_ID);
            $criteria->addSelectColumn(PagePeer::ACCESS_TOKEN);
            $criteria->addSelectColumn(PagePeer::LAST_SYNC);
    ...
    public static function doCountJoinFoundation(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(PagePeer::FOUNDATION_ID, FoundationPeer::ID, $join_behavior);
    ...
    public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(PagePeer::USER_ID, UserPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Page objects pre-filled with their Foundation objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinFoundation(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Page) to $obj2 (Foundation)
                $obj2->addPage($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Page) to the collection in $obj2 (Foundation)
                $obj2->addPage($obj1);
    ...
    /**
     * Selects a collection of Page objects pre-filled with all related objects except Foundation.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
