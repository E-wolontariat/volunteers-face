 ...
 */
abstract class BaseRound extends BaseObject 
{
    ...
    /**
     * The value for the show_results field.
    ...
    /**
     * Initializes internal state of BaseRound object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [show_results] column value.
     * 
     * @return   boolean
     */
    ...
    public function setFrom($v)
    {
        ...
        if ($this->from !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = RoundPeer::FROM;
            }
    ...
    public function setTo($v)
    {
        ...
        if ($this->to !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = RoundPeer::TO;
            }
        } // if either are not null
    ...
    /**
     * Sets the value of the [show_results] column.
     ...
     * @return   Round The current object (for fluent API support)
     */
    public function setShowResults($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
        ...
        if ($this->show_results !== $v) {
            $this->show_results = $v;
            $this->modifiedColumns[] = RoundPeer::SHOW_RESULTS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->show_results = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
            ...
            return $startcol + 6; // 6 = RoundPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
			...
			foreach (sfMixer::getCallables('BaseRound:delete:pre') as $callable)
			{
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseRound:delete:post') as $callable)
				{
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseRound:save:pre') as $callable)
			{
            ...
            if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(RoundPeer::CREATED_AT))
				{
            ...
            if ($ret) {
                ...
                $this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseRound:save:post') as $callable)
				{
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = RoundPeer::ID;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . RoundPeer::ID . ')');
        }
        ...
        if ($this->isColumnModified(RoundPeer::FROM)) {
            $modifiedColumns[':p' . $index++]  = '`FROM`';
        }
        if ($this->isColumnModified(RoundPeer::TO)) {
            $modifiedColumns[':p' . $index++]  = '`TO`';
        }
        if ($this->isColumnModified(RoundPeer::SHOW_RESULTS)) {
            $modifiedColumns[':p' . $index++]  = '`SHOW_RESULTS`';
        }
        if ($this->isColumnModified(RoundPeer::UPDATED_AT)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`TO`':
                        ...
                        break;
                    case '`SHOW_RESULTS`':
						$stmt->bindValue($identifier, (int) $this->show_results, PDO::PARAM_INT);
                        break;
                    case '`UPDATED_AT`':
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setShowResults($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RoundPeer::FROM)) $criteria->add(RoundPeer::FROM, $this->from);
        if ($this->isColumnModified(RoundPeer::TO)) $criteria->add(RoundPeer::TO, $this->to);
        if ($this->isColumnModified(RoundPeer::SHOW_RESULTS)) $criteria->add(RoundPeer::SHOW_RESULTS, $this->show_results);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setShowResults($this->getShowResults());
     ...
     * If this Round is new, it will return
    ...
    public function __call($name, $params)
    {
		...
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseRound:' . $name))
		{
