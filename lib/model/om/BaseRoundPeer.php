...
abstract class BaseRoundPeer {
    ...
    /** the column name for the SHOW_RESULTS field */
    const SHOW_RESULTS = 'round.SHOW_RESULTS';

    /** the column name for the UPDATED_AT field */
    const UPDATED_AT = 'round.UPDATED_AT';

    /** the column name for the CREATED_AT field */
    const CREATED_AT = 'round.CREATED_AT';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'From', 'To', 'ShowResults', 'UpdatedAt', 'CreatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'from', 'to', 'showResults', 'updatedAt', 'createdAt', ),
        BasePeer::TYPE_COLNAME => array (self::ID, self::FROM, self::TO, self::SHOW_RESULTS, self::UPDATED_AT, self::CREATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'FROM', 'TO', 'SHOW_RESULTS', 'UPDATED_AT', 'CREATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'from', 'to', 'show_results', 'updated_at', 'created_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'From' => 1, 'To' => 2, 'ShowResults' => 3, 'UpdatedAt' => 4, 'CreatedAt' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'from' => 1, 'to' => 2, 'showResults' => 3, 'updatedAt' => 4, 'createdAt' => 5, ),
        BasePeer::TYPE_COLNAME => array (self::ID => 0, self::FROM => 1, self::TO => 2, self::SHOW_RESULTS => 3, self::UPDATED_AT => 4, self::CREATED_AT => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'FROM' => 1, 'TO' => 2, 'SHOW_RESULTS' => 3, 'UPDATED_AT' => 4, 'CREATED_AT' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'from' => 1, 'to' => 2, 'show_results' => 3, 'updated_at' => 4, 'created_at' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(RoundPeer::FROM);
            $criteria->addSelectColumn(RoundPeer::TO);
            $criteria->addSelectColumn(RoundPeer::SHOW_RESULTS);
            $criteria->addSelectColumn(RoundPeer::UPDATED_AT);
            $criteria->addSelectColumn(RoundPeer::CREATED_AT);
        } else {
            $criteria->addSelectColumn($alias . '.ID');
            $criteria->addSelectColumn($alias . '.FROM');
            $criteria->addSelectColumn($alias . '.TO');
            $criteria->addSelectColumn($alias . '.SHOW_RESULTS');
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
		...
		{
		  call_user_func($sf_hook, 'BaseRoundPeer', $criteria, $con);
		}
     ...
     *
     * @param      Round $obj A Round object.
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(RoundPeer::ID) && $criteria->keyContainsValue(RoundPeer::ID) ) {
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseRoundPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
