...
abstract class BaseUser extends BaseObject implements Persistent
{
     ...
     * @return PropelObjectCollection|Page[] List of Page objects
     */
    public function getPagesJoinFoundation($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = PageQuery::create(null, $criteria);
        $query->joinWith('Foundation', $join_behavior);
     ...
     * @return PropelObjectCollection|UserEvent[] List of UserEvent objects
     */
    public function getUserEventsJoinFoundation($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = UserEventQuery::create(null, $criteria);
        $query->joinWith('Foundation', $join_behavior);
