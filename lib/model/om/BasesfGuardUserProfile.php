...
abstract class BasesfGuardUserProfile extends BaseObject 
{
    ...
    public function setFacebookId($v)
    {
        ...
        if ($this->facebook_id !== $v) {
            $this->facebook_id = $v;
            $this->modifiedColumns[] = sfGuardUserProfilePeer::FACEBOOK_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 7; // 7 = sfGuardUserProfilePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(sfGuardUserProfilePeer::FACEBOOK_ID)) {
        ...
        if ($this->isColumnModified(sfGuardUserProfilePeer::EMAIL)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(sfGuardUserProfilePeer::FACEBOOK_ID)) $criteria->add(sfGuardUserProfilePeer::FACEBOOK_ID, $this->facebook_id);
