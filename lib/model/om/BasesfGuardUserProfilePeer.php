...
abstract class BasesfGuardUserProfilePeer {
    ...
    const FACEBOOK_ID = 'sf_guard_user_profile.FACEBOOK_ID';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'FacebookId', 'FirstName', 'LastName', 'Email', 'Website', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'facebookId', 'firstName', 'lastName', 'email', 'website', ),
        BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::FACEBOOK_ID, self::FIRST_NAME, self::LAST_NAME, self::EMAIL, self::WEBSITE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USER_ID', 'FACEBOOK_ID', 'FIRST_NAME', 'LAST_NAME', 'EMAIL', 'WEBSITE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'facebook_id', 'first_name', 'last_name', 'email', 'website', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'FacebookId' => 2, 'FirstName' => 3, 'LastName' => 4, 'Email' => 5, 'Website' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'facebookId' => 2, 'firstName' => 3, 'lastName' => 4, 'email' => 5, 'website' => 6, ),
        BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::FACEBOOK_ID => 2, self::FIRST_NAME => 3, self::LAST_NAME => 4, self::EMAIL => 5, self::WEBSITE => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USER_ID' => 1, 'FACEBOOK_ID' => 2, 'FIRST_NAME' => 3, 'LAST_NAME' => 4, 'EMAIL' => 5, 'WEBSITE' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'facebook_id' => 2, 'first_name' => 3, 'last_name' => 4, 'email' => 5, 'website' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(sfGuardUserProfilePeer::FACEBOOK_ID);
