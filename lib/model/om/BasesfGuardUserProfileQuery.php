 ...
 * @method     sfGuardUserProfileQuery orderByFacebookId($order = Criteria::ASC) Order by the facebook_id column
 ...
 * @method     sfGuardUserProfileQuery groupByFacebookId() Group by the facebook_id column
 ...
 * @method     sfGuardUserProfile findOneByFacebookId(string $facebook_id) Return the first sfGuardUserProfile filtered by the facebook_id column
 ...
 * @method     array findByFacebookId(string $facebook_id) Return sfGuardUserProfile objects filtered by the facebook_id column
...
abstract class BasesfGuardUserProfileQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `USER_ID`, `FACEBOOK_ID`, `FIRST_NAME`, `LAST_NAME`, `EMAIL`, `WEBSITE` FROM `sf_guard_user_profile` WHERE `ID` = :p0';
        try {
    ...
    public function filterByFacebookId($facebookId = null, $comparison = null)
    {
        if (is_array($facebookId)) {
            ...
            if (isset($facebookId['min'])) {
                $this->addUsingAlias(sfGuardUserProfilePeer::FACEBOOK_ID, $facebookId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($facebookId['max'])) {
                $this->addUsingAlias(sfGuardUserProfilePeer::FACEBOOK_ID, $facebookId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(sfGuardUserProfilePeer::FACEBOOK_ID, $facebookId, $comparison);
    }
